...
`track_vis()` in `ikhyd` package as in the following Figure:
...
The following figure shows the Speed information from GPS sensor stored
in `speed_data`, which can be visualized with `plot_speed()` as follows:
...
<img src="man/figures/README-unnamed-chunk-13-1.png" alt="Visualization of the Kalman filtering based calibration" width="100%" />
...
<img src="man/figures/README-unnamed-chunk-15-1.png" alt="Visualization of the Kalman smoothing based calibration" width="100%" />
...
<img src="man/figures/README-unnamed-chunk-18-1.png" alt="Comparion of Speed: GPS(red) vs. OBD(black)" width="100%" />
...
<img src="man/figures/README-unnamed-chunk-19-1.png" alt="Comparion of Acceleration: Accelerometer(red) vs. OBD(black)" width="100%" />
...
<img src="man/figures/README-unnamed-chunk-20-1.png" alt="Comparion of Acceleration: Kalman filter base(red) vs. OBD(black)" width="100%" />
...
<img src="man/figures/README-unnamed-chunk-21-1.png" alt="Comparion of Acceleration: Kalman smooth base(red) vs. OBD(black)" width="100%" />
...
<img src="man/figures/README-unnamed-chunk-23-1.png" alt="Reproduce V-A heatmap result for 2 drivers" width="50%" /><img src="man/figures/README-unnamed-chunk-23-2.png" alt="Reproduce V-A heatmap result for 2 drivers" width="50%" />
...
<img src="man/figures/README-unnamed-chunk-24-1.png" alt="Reproduce Lon-Lat plot result for drivers; 1 and 2" width="50%" /><img src="man/figures/README-unnamed-chunk-24-2.png" alt="Reproduce Lon-Lat plot result for drivers; 1 and 2" width="50%" />
